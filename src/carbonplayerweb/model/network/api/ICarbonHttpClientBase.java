...
import io.reactjava.client.gwt.react.IProvider;

// IHttpClientBase ========================//
public interface ICarbonHttpClientBase extends IProvider
{
   // constants ------------------------- //
...
@name       setErrorReason - set the specified error reason
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setErrorReason(
      String errorReason);
...
@name       setMethod- set the specified response type
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setMethod(
      String method);
...
@name       setReadyStateChangedListener - set the readyStateChanged listener
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setReadyStateChangedListener(
...
@name       setRequestHeader - set the specified request header
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setRequestHeader(
      String headerName,
      String value);
...
@name       setRequestor - set the specified requestor
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setRequestor(
      APIRequestor requestor);
...
@name       setRequestToken - set the specified request token
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setRequestToken(
      Object requestToken);
...
@name       setResponseType - set the specified response type
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setResponseType(
...
@name       setStatusText - set status text
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setStatusText(
      String statusText);
...
@name       setTimeout - set that a timeout occurred
    ...
    */
   //------------------------------------------------------------------------------
   ICarbonHttpClientBase setTimeout();
